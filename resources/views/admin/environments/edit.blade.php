...
<div class="nk-block">
    ...
    <div class="card card-bordered">
        <div class="card-inner">
            <div class="card-head">
                <h5 class="card-title">Edit Environment: {{ $environment->name }}</h5>
            </div>
            
            <form action="{{ route('admin.environments.update', $environment) }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                       id="name" name="name" value="{{ old('name', $environment->name) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" 
                                       id="slug" name="slug" value="{{ old('slug', $environment->slug) }}" 
                                       placeholder="e.g., development, staging, production" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Brief description of this environment">{{ old('description', $environment->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control @error('server_base_path') is-invalid @enderror" 
                                       id="server_base_path" name="server_base_path" value="{{ old('server_base_path', $environment->server_base_path) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control @error('server_unc_path') is-invalid @enderror" 
                                       id="server_unc_path" name="server_unc_path" value="{{ old('server_unc_path', $environment->server_unc_path) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="url" class="form-control @error('web_base_url') is-invalid @enderror" 
                                       id="web_base_url" name="web_base_url" value="{{ old('web_base_url', $environment->web_base_url) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="url" class="form-control @error('deploy_endpoint_base') is-invalid @enderror" 
                                       id="deploy_endpoint_base" name="deploy_endpoint_base" value="{{ old('deploy_endpoint_base', $environment->deploy_endpoint_base) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" class="form-control @error('order') is-invalid @enderror" 
                                       id="order" name="order" value="{{ old('order', $environment->order) }}" 
                                       placeholder="1" min="0">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" {{ old('is_active', $environment->is_active) ? 'checked' : '' }}>
